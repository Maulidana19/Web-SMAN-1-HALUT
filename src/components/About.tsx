...
export const About: React.FC = () => {
  const coreValues = [
    {
      ...
      title: "Berkarakter",
      desc: "Menjunjung tinggi nilai moral, etika, dan tanggung jawab sosial."
    },
    {
      icon: <Award className="w-6 h-6 sm:w-10 sm:h-10 text-brand-red" />,
      title: "Berprestasi",
      desc: "Berorientasi pada keunggulan akademik dan non-akademik."
    },
    {
      icon: <Target className="w-6 h-6 sm:w-10 sm:h-10 text-brand-red" />,
      title: "Inovatif",
      desc: "Terbuka terhadap ide baru dan berani menciptakan solusi kreatif."
    },
    {
      icon: <Compass className="w-6 h-6 sm:w-10 sm:h-10 text-brand-red" />,
      title: "Adaptif",
      desc: "Siap menghadapi perubahan dan kemajuan teknologi secara positif."
    }
  ];
  ...
  return (
    <div id="about" className="bg-gray-50">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4 sm:gap-6">
            ...
            <div className="bg-brand-red text-white p-5 sm:p-10 rounded-[20px] sm:rounded-3xl shadow-lg shrink-0 transition-transform duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold font-display tracking-wide">Visi Sekolah</h3>
              </div>
              <p className="text-sm sm:text-base font-medium leading-relaxed italic text-red-50 text-justify">
                "{SCHOOL_INFO.vision}"
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4 sm:space-y-6 flex-1">
              {SCHOOL_INFO.missions.map((misi, idx) => (
                <div key={idx} className="flex gap-3 sm:gap-5 items-start group/misi">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed group-hover/misi:text-white transition-colors duration-300 text-justify">
                    {misi}
                  </p>
                </div>
              ))}
      ...
      {/* 2.1 TUJUAN SECTION (Matching layout) */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4 relative z-10 mt-6 lg:mt-8">
        <div className="bg-white text-slate-800 p-5 sm:p-8 rounded-[20px] sm:rounded-3xl shadow-lg border border-gray-100 transition-transform duration-300 hover:-translate-y-1">
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-50 text-brand-red rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0">
              <Target className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="text-gray-600 text-sm sm:text-base leading-relaxed space-y-4 text-justify">
              ...
              <p>{SCHOOL_INFO.shortDescription}</p>
            </div>
          </div>
        </div>
