    ...
    <section id="achievements-section" className="py-10 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-xs font-bold uppercase tracking-widest text-blue-600 mb-3">Prestasi & Penghargaan</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch mb-16">
          {ACHIEVEMENTS_DATA.map((ach, idx) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-2xl border border-slate-100 hover:shadow-2xl hover:translate-y-[-4px] hover:border-blue-100 transition-all duration-300 flex flex-col justify-between text-left relative overflow-hidden group"
            >
              {/* Decorative faint background trophy */}
              <div className="absolute right-0 bottom-0 translate-x-6 translate-y-6 text-slate-100/40 group-hover:text-blue-50/50 transition-colors duration-300 -z-0">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-blue-600 transition-colors leading-snug font-display">
                  {ach.title}
                </h3>
              ...
              <div className="mt-8 pt-4 border-t border-slate-50 relative z-10 flex items-center gap-2 text-blue-600 font-bold text-xs uppercase tracking-wider group-hover:translate-x-1.5 transition-transform duration-300">
        ...
        <div className="bg-[#f1f5f9]/50 rounded-2xl p-8 text-center max-w-4xl mx-auto border border-slate-100">
          ...
          <span className="block text-xs font-bold text-blue-600 uppercase tracking-widest mt-3">— Dewan Pembina Prestasi Siswa</span>
        </div>
