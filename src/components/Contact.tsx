...
interface ContactProps {
  view?: 'all' | 'hubungi' | 'lokasi';
}

export const Contact: React.FC<ContactProps> = ({ view = 'all' }) => {
  // Form fields
  ...
  const renderContactForm = () => (
    <div className="bg-white p-8 sm:p-10 rounded-2xl border border-slate-100 shadow-2xl text-left">
  ...
  const renderMapBlock = () => (
    <div className="flex flex-col gap-6 h-full text-left">
      <div className="flex-1 bg-white p-4 rounded-2xl border border-slate-100 shadow-2xl flex flex-col justify-between min-h-[350px]">
        <div className="p-2 sm:p-4 bg-[#f1f5f9]/50 rounded-xl flex-1 min-h-[250px] overflow-hidden relative border border-slate-100">
          <iframe
        ...
        <div className="pt-4 text-left px-2 flex-shrink-0">
          <h4 className="font-bold text-slate-800 text-base mb-1 font-display">Panduan Lokasi Fisik</h4>
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
            SMA Negeri 1 Halmahera Utara terletak di kawasan strategis pusat kota Tobelo. Akses menuju lokasi sangat mudah dijangkau menggunakan kendaraan roda dua maupun roda empat dari arah pelabuhan Tobelo maupun bandar udara terdekat.
          </p>
        </div>
      </div>
    </div>
  ...
  // VIEW FOR HUBUNGI KAMI ONLY
  if (view === 'hubungi') {
    return (
      <section id="contact-hubungi" className="py-10 sm:py-16 bg-[#f1f5f9]/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-xs font-bold uppercase tracking-widest text-brand-red mb-3">Hubungi Kami</h2>
  ...
  // VIEW FOR LOKASI ONLY
  if (view === 'lokasi') {
    return (
      <section id="contact-lokasi" className="py-10 sm:py-16 bg-[#f1f5f9]/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-xs font-bold uppercase tracking-widest text-brand-red mb-3">Peta Lokasi</h2>
            <p className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight font-display">
              Lokasi SMAN 1 Halmahera Utara
            </p>
            <div className="h-1 w-12 bg-brand-red mx-auto mt-4 rounded-full" />
          </div>
